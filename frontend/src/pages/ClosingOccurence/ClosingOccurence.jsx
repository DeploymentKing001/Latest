...
const ClosingOccurence = () => {
  ...
  useEffect(() => {
    axios.get("https://final-management-app.vercel.app/getSaveOccurence")
      .then((res) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://final-management-app.vercel.app/getnewoccuranceAllStatusWithZeroAndTwo")
      .then((response) => {
    ...
    axios
      .get("https://final-management-app.vercel.app/getGarrisonAll")
      .then((response) => {
    ...
    axios.get('https://final-management-app.vercel.app/newGarissonData')
      .then((response) => {
    ...
    axios.get("https://final-management-app.vercel.app/getApplicants").then((response) => {
      setApplicants(response.data);
      console.log(response.data);
    });

    axios.get("https://final-management-app.vercel.app/getStreet").then((response) => {
  ...
  const handleDeleteClick = (e) => {
    ...
    axios.post("https://final-management-app.vercel.app/createreport", { IdOfOccurence, formFields, description })
      .then((response) => {
    ...
    axios
      .put(`https://final-management-app.vercel.app/updataGarrisonToTrue/${id}`)
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
    ...
    axios.put(`https://final-management-app.vercel.app/occuranceclosed/${id}`, { ClosedBy })
      .then((response) => {
    ...
    axios
      .put(`https://final-management-app.vercel.app/updataGarrisonStat`, {})
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
  ...
  const handleCloseAndDelete = () => {
    axios.delete(`https://final-management-app.vercel.app/saveOccurenceDelete/${idForSaving}`)
      .then((res) => {
  ...
  const showReport = (id) => {
    ...
    axios.get(`https://final-management-app.vercel.app/view-pdf/new/${id}?ReportCreatedBy=${ReportCreatedBy}`, { responseType: 'text' })
      .then((response) => {
  ...
  const handleClose = (event, reason) => {
    ...
    if (reason !== 'backdropClick' && reason !== 'escapeKeyDown') {
      ...
      axios.put(`https://final-management-app.vercel.app/saveOccurence/${idForSaving}`, { formFields, description })
        .then((res) => {
          console.log(res)
          setOpen(false);
          // setSelectedValue(""); // Reset selectedValue on dialog close
  ...
  const onActive = (id) => {
    ...
    axios.put(`https://final-management-app.vercel.app/newGarisonActive/${id}`).then((response) => console.log(response))

    axios.get('https://final-management-app.vercel.app/newGarissonData').then((response) => {
      setGarison(response.data);
    })
  ...
  const onInActive = (id) => {
    ...
    axios.put(`https://final-management-app.vercel.app/newGarisonInActive/${id}`).then((response) => console.log(response))
    axios.get('https://final-management-app.vercel.app/newGarissonData').then((response) => {
      setGarison(response.data);
    })
                  ...
                  return (
                    <div className="col-md-12 col-sm-12 my-3 occurancea_holds row">
                      <div className="col-md-10 row">
                        ...
                        <div className="col-md-3 col-sm-12 example-class">
                    ...
                    <div className="col-md-3 col-sm-12">
                      <h6>Tempo total gasto: {TimeDifference} </h6>
                        ...
                        <div className="col-md-6 col-sm-12 gu_list example-class">
                          <br />
                          <h6> Gu Lista : </h6>
