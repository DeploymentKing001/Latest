...
const GuOfTheDay = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get("https://latest-nu.vercel.app/getnewoccuranceAllStatus")
      .then((response) => {
  ...
  const handleData = (e) => {
    ...
    axios.put(`https://latest-nu.vercel.app/occuranceDispatch/${occuranceId}`, { DispatchBy })
      .then((response) => {
        console.log("data is ", response);
        axios.get("https://latest-nu.vercel.app/getnewoccuranceAllStatus")
          .then((response) => {
            SetOccurance_hold(response.data);
          })
          .catch((error) => {
    ...
    // dispatch time added 
    axios.put(`https://latest-nu.vercel.app/occuranceDispatchTime/${occuranceId}`)
      .then((response) => {
    ...
    axios.put(`https://latest-nu.vercel.app/updataGarrison`, { dataArray: bunchId })
      .then((response) => {
        console.log(response);
        // Fetch updated GarisonFalse data after dispatch
        axios.get("https://latest-nu.vercel.app/getGarrison")
          .then((response) => {
            setGarisonFalse(response.data);
    ...
    axios.put(`https://latest-nu.vercel.app/occuranceDispatchGarison/${occuranceId}`, { dataArray: av_garison })
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
