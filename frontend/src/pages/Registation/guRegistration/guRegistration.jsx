...
const GuRegistration = () => {
  ...
  useEffect(() => {
    axios.get('https://final-management-app.vercel.app/getStaffStatus')
      .then((response) => {
    ...
    axios.get('https://final-management-app.vercel.app/getVehcleStatus')
      .then((response) => {
  ...
  const handleDelete = (e) => {
    ...
    if (garison.length > 0) {
      ...
      axios.delete('https://final-management-app.vercel.app/deleteGarrisonStatus')
        .then((response) => {
      ...
      axios.put('https://final-management-app.vercel.app/statustrueStaff')
        .then((response) => {
      ...
      axios.put('https://final-management-app.vercel.app/statustrueVehcle')
        .then((response) => {
          // console.log(dispatch, response.data)
        })
        .catch((error) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post('https://final-management-app.vercel.app/newGarisson', postData);
      ...
      const updateVehicleResponse = await axios.put(`https://final-management-app.vercel.app/updateVehicle/${vechicleId}`);
      console.log(updateVehicleResponse);
      console.log("update vehicle api working");

      const updateStaffResponse = await axios.put('https://final-management-app.vercel.app/updateStaff', { dataArray: staffIds });
      console.log(updateStaffResponse);
      console.log("update staff api working");

      // Fetch updated garisson data
      // const garissonResponse = await axios.get('https://final-management-app.vercel.app/newGarissonData');
      // setGarison(garissonResponse.data);
      // console.log("New garission data api working");

      // Fetch updated vehicle and staff status
      const vehicleResponse = await axios.get('https://final-management-app.vercel.app/getVehcleStatus');
      setVehicle(vehicleResponse.data);
      console.log("getVehicle stats api working");

      const staffResponse = await axios.get('https://final-management-app.vercel.app/getStaffStatus');
      setStaff(staffResponse.data);
      console.log("getstaff stats api working");

      // Fetch updated garisson data again
      const updatedGarissonResponse = await axios.get('https://final-management-app.vercel.app/newGarissonData');
