...
const ViewItems = () => {
  ...
  useEffect(() => {
    axios.get("https://latest-nu.vercel.app/admin/dashboard/viewitems/getRegisteredUser")
      .then((res) => {
  ...
  const handleSave = () => {
    axios.put(`https://latest-nu.vercel.app/updateOccurence/${selectedUser._id}`, { username, password, designation })
      .then((res) => {
        console.log(res);
  ...
  const handleConfirmDelete = () => {
    ...
    axios.delete(`https://latest-nu.vercel.app/deleteoccurrence/${selectedUser._id}`)
      .then((res) => {
