...
const ServiceNew = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://latest-nu.vercel.app/getoccurance")
      .then((response) => {
    ...
    axios
      .get("https://latest-nu.vercel.app/getnewoccurance")
      .then((response) => {
        // Set the fetched data in state
    ...
    axios
      .get("https://latest-nu.vercel.app/getGarrison")
      .then((response) => {
    ...
    axios
      .get("https://latest-nu.vercel.app/getGarrisonFalse")
      .then((response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const responsePost = await axios.post("https://latest-nu.vercel.app/newOccurance", { ...post, MadeBy });
      console.log(responsePost);

      // Call the API to delete old occurrences with status 0 or 2
      await axios.delete("https://latest-nu.vercel.app/deleteOldOccurrences", { data: post });


      if (StaffIds.length !== 0) {
        console.log("Callled");
        const updateStaffResponse = await axios.put('https://latest-nu.vercel.app/updateGarrisoninServiceNew', { dataArray: StaffIds });
      ...
      // const responsePut = await axios.put(`https://latest-nu.vercel.app/updataGarrison/${GarrisonId}`);
      // console.log(responsePut);

      const responseGetGarrison = await axios.get("https://latest-nu.vercel.app/getGarrison");
      setNewGarrison(responseGetGarrison.data);
      console.log("Garrison", responseGetGarrison.data);

      const responseGetGarrisonFalse = await axios.get("https://latest-nu.vercel.app/getGarrisonFalse");
    ...
    // Here when the form is submitted delete the record with the status value 0, 2 if found you have to do it chatgpt and also make a backend api. we are doing this because we have now another document of occurance with different status so we dont need the other document with old status.
  ...
  const occurenceUpdate = async () => {
    axios.put(`https://latest-nu.vercel.app/updateOccurenceInServices`, { post, OccurenceIdForUpdate })
      .then((res) => {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-center ">
              ...
              <input
                ...
                class="btn btn-primary p-3 m-3 w-50 text-center" value="Editar" type="button" />
