...
const ArrivalAtOccurence = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://latest-nu.vercel.app/getnewoccuranceAllStatusWithZero")
      .then((response) => {
    ...
    axios.get(`https://latest-nu.vercel.app/getnewoccuranceocurrencesgarissonwithtruedisabled/${arriveId}`)
      .then((response) => {
  ...
  const handleInput = (e) => {
    ...
    axios
      .get(`https://latest-nu.vercel.app/getnewoccuranceAllStatus/${id}`)
      .then((response) => {
  ...
  const handleStatus = (e) => {
    e.preventDefault();
    axios.put(`https://latest-nu.vercel.app/occuranceDispatcharrivegarrison/${arriveId}`, { garissonIds })
      .then((response) => {
        // Update Occurance_hold after the arrival status has been successfully updated
        setjugaar(response)
        setFindGarission([])
        axios.get("https://latest-nu.vercel.app/getnewoccuranceAllStatusWithZero")
          .then((response) => {
            setOccurance_hold(response.data);
          })
          .catch((error) => {
    ...
    if (alltruegarrisionallgarison === allgarisonLength) {
      ...
      axios.put(`https://latest-nu.vercel.app/occuranceDispatcharrive/${arriveId}`, { InformedOfArrivalBy })
        .then((response) => {
      ...
      axios.put(`https://latest-nu.vercel.app/getnewoccuranceAllStatusWithZero/${arriveId}`)
        .then((response) => {
          console.log("data is ", response);
          axios
            .get("https://latest-nu.vercel.app/getnewoccuranceAllStatusWithZero")
