...
const Home = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get("https://final-management-app.vercel.app/getnewoccuranceAllStatusWithZeroAndTwo")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setoccurenceInCareLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/getnewoccuranceOpenCases")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setopenCasesLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/getAllStaff")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setStaffRegistrationsLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/getVehcle")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setvehicleRegistrationsLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/getGarrisonTrue")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setguAvailableLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/getGarrisonFalse")
            .then((response) => {
                let data = response.data
                // console.log(data.length)
                setguNotAvailableLength(data.length)
        })
        axios.get("https://final-management-app.vercel.app/occurrences/today")
            .then((response) => {
                let data = response.data.count
                // console.log("today total occuenrences : " , data)
                settodayOccurencesLength(data)
        })
        axios.get("https://final-management-app.vercel.app/occurrences/month")
            .then((response) => {
                let data = response.data.count
                // console.log(data.length)
                setMonthOccurencesLength(data)
        })
        axios.get("https://final-management-app.vercel.app/occurrences/year")
            .then((response) => {
                let data = response.data.count
                // console.log(data.length)
