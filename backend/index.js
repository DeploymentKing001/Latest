...
const allowedOrigin = 'https://66574c17a6881a35c6277b95--storied-frangollo-2db7b4.netlify.app'; {/* I have to edit his path later */ }
...
app.get('/view-pdf/new/:id', async (req, res) => {
  ...
  try {
    ...
    res.render('partialreport', { occurrence, ReportCreatedBy });
...
app.get('/create-pdf/new/:id', async (req, res) => {
  ...
  try {
    ...
    res.render('advancereport', { occurrence, report, ReportCreatedBy, dateString, timeString });
